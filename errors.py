...
class show_error(QDialog):
    ...
    def test_name_not_specified(self):
        reply = QMessageBox.critical(self, "Test name not specified",
                                     # error with test name
                                     "Test name is not specified. Please specify test name and try again.",
                                     QMessageBox.Retry)
        return reply
    ...
    # def controller_not_connected(self):  # for not starting test				# error mention in main file
    #     try:
