...
class check_before_start():
	...
	def checks(self):
		...
		if not (self.ui.is_roller.isChecked()): 				#	if not (self.ui.is_roller.isChecked() or self.ui.is_axis.isChecked()):
			self.ready_for_test = False
		...
		self.data_file = self.ui.save_directory.text()+"/"+self.ui.test_name.text()+"/"+self.ui.test_name.text()+".csv"
