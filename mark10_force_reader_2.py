...
class mark10_f_values_2(QtCore.QThread):                                                ###         mark10_f_values_2
    ...
    def __init__(self):
        super(mark10_f_values_2, self).__init__()                                           ###         mark10_f_values_2
        # self.com = "COM3"
            ...
            try:    
                ...
                if available_bytes >= 8:
                    try:
                        ...
                        self.present_reading_2 = abs(
                            round((self.read_value - self.zero_value), 4))                      ###     resent_reading_2
